...
setwd(paste("~/Documents/Projects/PZIFE/C_scripts_and_data/dataFromCluster/TrialRun_2018_09_14/s10m",sep=""))
...
legend("top",c("C=0.004", "C=0.04", "C=0.4", "C=4", "U=0.00004", "U=0.0004", "U=0.004","U=0.04","X=0.000004","X=0.00004","X=0.0004"),ncol = 8, 
       col=c(1,1,1,1,arr_color[1],arr_color[2],arr_color[3],arr_color[4],1,1,1),pch=c(tipo[1],tipo[2],tipo[3],tipo[4],NA,NA,NA,NA,tipo[5],tipo[5],tipo[5]),
       lty=c(NA,NA,NA,NA,1,1,1,1,NA,NA,NA),pt.cex=c(1,1,1,1,2,2,2,2,tamany[1],tamany[2],tamany[3]),
       lwd=c(NA,NA,NA,NA,3,3,3,3,NA,NA,NA),bty = "n",x.intersp=0.05)
...
plot(-100,1000,ylim=c(.001,ymax),
     xlim=c(xmin,xmax),ylab="Effective mut. rate",xlab="",xaxt="n",las=2,log="y",cex.lab=tamanyLab,cex.axis=.8)
...
count=0
plot(-100,-100,ylim=c(0,ymax),xlim=c(xmin,xmax),ylab="Prdm9 diversity",xlab="",xaxt="n",las=2,cex.lab=tamanyLab)
for(i in 1:length(arrayP)){
  count=0
  # for(j in 1:length(arrayU)){
  for(k in 1:length(arrayD)){
...
ymax=1
count=0
plot(-100,-100,ylim=c(0,ymax),xlim=c(xmin,xmax),ylab="Rec Activity",xlab="",xaxt="n",las=2,cex.lab=tamanyLab)
for(i in 1:length(arrayP)){
  count=0
  # for(j in 1:length(arrayU)){
  for(k in 1:length(arrayD)){
      ...
      for(o in 1:length(arrayE)){
        ...
        if(is.na(val) == TRUE){
          ...
          if(substr(eco,1,5)=="alpha"){
            ...
            prom=mean(as.numeric(valores))
            stand=sd(as.numeric(valores))
            points(((i-1)*1000+((k-1)*250)+((l-1)*60)+(o-1)*15),prom,col=arr_color[l],pch=tipo[k],cex=tamany[o],cex.lab=tamanyLab)
            points(((i-1)*1000+((k-1)*250)+((l-1)*60)+(o-1)*15),prom+stand,col=1,pch=1,cex=0.3)
            points(((i-1)*1000+((k-1)*250)+((l-1)*60)+(o-1)*15),prom-stand,col=1,pch=1,cex=0.3)
          }
        }
...
ymax=2000
count=0
plot(-100,1,ylim=c(1,ymax),xlim=c(xmin,xmax),ylab="Sel coeff",xlab="",xaxt="n",las=2,log="y")
for(i in 1:length(arrayP)){
  count=0
  # for(j in 1:length(arrayU)){
  for(k in 1:length(arrayD)){
...
ymax=1
count=0
plot(-100,-100,ylim=c(0,ymax),xlim=c(xmin,xmax),ylab="AA Div. at Binding",xlab="",xaxt="n",las=2,cex.lab=tamanyLab)
for(i in 1:length(arrayP)){
  count=0
  # for(j in 1:length(arrayU)){
  for(k in 1:length(arrayD)){
...
ymax=2
count=0
plot(-100,-100,ylim=c(0,ymax),xlim=c(xmin,xmax),ylab="Disp in array",xlab="",xaxt="n",las=2,cex.lab=tamanyLab)
for(i in 1:length(arrayP)){
  count=0
  # for(j in 1:length(arrayU)){
  for(k in 1:length(arrayD)){
...
ymax=1
count=0
plot(-100,-100,ylim=c(0,ymax),xlim=c(xmin,xmax),ylab="Hetz in array",xlab="",xaxt="n",las=2,cex.lab=tamanyLab)
for(i in 1:length(arrayP)){
  count=0
  # for(j in 1:length(arrayU)){
  for(k in 1:length(arrayD)){
...
ymax=20
count=0
plot(-100,-100,ylim=c(0,ymax),xlim=c(xmin,xmax),ylab="Size of array",xlab="",xaxt="n",las=2,cex.lab=tamanyLab)
for(i in 1:length(arrayP)){
  count=0
  # for(j in 1:length(arrayU)){
  for(k in 1:length(arrayD)){
      ...
      for(o in 1:length(arrayE)){
        ...
        if(is.na(val) == TRUE){
          ...
          if(substr(eco,1,5)=="alpha"){
            ...
            prom=mean(unlist(as.numeric(unlist(novA))))
            stand=sd(unlist(as.numeric(unlist(novA))))
...
ymax=1
count=0
plot(-100,-100,ylim=c(0,ymax),xlim=c(xmin,xmax),ylab="Mut type prop",xlab="",xaxt="n",las=2,cex.lab=tamanyLab)
      ...
      for(oo in 1:length(arrayE)){
        ...
        if(is.na(val) == TRUE){
          ...
          if(substr(eco,1,5)=="alpha"){
            ...
            prom=gralStats[5]/gralStats[7]
            promsZnf=gralStats[1]/gralStats[7]
            
            stand=gralStatsSD[5]/gralStats[7]
            standZnf=gralStatsSD[1]/gralStats[7]
            
            points(((ii-1)*1000+((kk-1)*250)+((ll-1)*60)+(oo-1)*15),prom,col=arr_color[ll],pch=tipo[kk],cex=tamany[oo])
            points(((ii-1)*1000+((kk-1)*250)+((ll-1)*60)+(oo-1)*15),promsZnf,col=arr_color[ll],pch=tipo2[kk],cex=tamany[oo])
            
            points(((i-1)*1000+((k-1)*250)+((l-1)*60)+(o-1)*15),prom+stand,col=1,pch=1,cex=0.3)
            points(((i-1)*1000+((k-1)*250)+((l-1)*60)+(o-1)*15),prom-stand,col=1,pch=1,cex=0.3)

            points(((i-1)*1000+((k-1)*250)+((l-1)*60)+(o-1)*15),prom+standZnf,col=2,pch=1,cex=0.3)
            points(((i-1)*1000+((k-1)*250)+((l-1)*60)+(o-1)*15),prom-standZnf,col=2,pch=1,cex=0.3)
          }
        }
        countE=countE+1
