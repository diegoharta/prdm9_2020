...
#label="prueba_pzife_1.999_prueba"
label="prueba5_D0C0U3_p2X3_b"
label="prueba6_1.999_N200_DNullC2aU3_p2X3c"
label="prueba6_1.999_N200_DNull2aU3_p2X3k10c"
label="prueba7_2.01_N200_DNullC0.4aU3_p2X3c"
label="prueba7_2.011_N200_DNullC0.4aU3_p2X3l"
label="prueba5_pzife_2.011_N200_p2_X3_DNull_C1_U3"
...
layout(m,heights = c(2,1.5,1.5,1.5,1.5,2.5))
...
classInvasionArray=c()
  for(jj in 1:nrow(lifetime)){
    if(lifetime[jj,]$Freqs>umbral){
      ...
      lugar=(lifetime[jj,]$Moment-profile$BurnIn)/profile$Interval
      text(lugar,1-.02*countInvasions,textoB,cex=.8,col=col_vector[newColorOrder[jj]])
...
prom=mean(as.numeric(g[1,(ncol(g)/6):ncol(g)]))
...
text(75*Prop,18,bquote(paste(tau,"_AC = ",.(timeDiffsBetweenInvasions),sep="")),cex=tamanyo)
...
classInvasionArray=c()
for(jj in 1:nrow(lifetime)){
  if(lifetime[jj,]$Times>3.0){
    textoA=lifetime[jj,]$BindingMotif
    textoB=paste(substr(textoA,1,3), "-", substr(textoA,4,6), "-", substr(textoA,7,9), sep="")
    lugar=(lifetime[jj,]$Moment-profile$BurnIn)/profile$Interval
    text(lugar,1-.05*countInvasions,textoB,cex=.8,col=col_vector[newColorOrder[jj]])
    text(lugar,umbral/10,"*")
    classInvasionArray[countInvasions]=lugar
    countInvasions=countInvasions+1
  }
