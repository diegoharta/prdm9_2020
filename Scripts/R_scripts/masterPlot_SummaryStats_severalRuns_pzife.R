...
simID="N100_t100_s1p"
paths="~/Documents/Projects/PZIFE/C_scripts_and_data/dataFromCluster/TrialRun_2018_09_24/s1p"
arrayP=c(2)
arrayE=c(5,3,1)
arrayD=c(2,0)
arrayU=c(4,2)
...
ymax=0.1*4*1000
count=0
plot(-100,-100,ylim=c(0,ymax),xlim=c(xmin,xmax),ylab="Selection coefficient",xlab="",xaxt="n",las=2)
for(i in 1:length(arrayP)){
  count=0
  # for(j in 1:length(arrayU)){
  for(k in 1:length(arrayD)){
